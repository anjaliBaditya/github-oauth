...
const GitHubCalendar: FunctionComponent<Props> = ({
  ...
  return (
    <Calendar
      data={transformData(data.contributions, props.transformData)}
      theme={theme}
      labels={Object.assign({}, defaultLabels, props.labels)}
      totalCount={props.transformData && props.transformTotalCount ? undefined : totalCount}
      {...props}
